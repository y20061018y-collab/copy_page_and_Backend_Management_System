...
export default function AdminGames() {
  ...
  return <AdminLayout active="games" crumb="游戏目录">
    <AdminPageTitle eyebrow="CONTENT CATALOG" title="游戏目录" description="维护前台展示的游戏、封面、简介、服务内容和排序。" actions={<a className="admin-v2-primary" href="/admin/games/new">＋ 新增游戏</a>} />
