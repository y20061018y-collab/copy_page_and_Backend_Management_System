...
export default function NewGame() {
  ...
  return <AdminLayout active="games" crumb="新增游戏"><AdminPageTitle eyebrow="NEW GAME" title="新增游戏" description="创建后可继续在编辑页管理服务和前台展示顺序。" actions={<a className="admin-v2-secondary" href="/admin/games">返回目录</a>} />
